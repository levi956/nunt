...
class _$NewsModelImpl implements _NewsModel {
  ...
  @override
  String toString() {
    return 'NewsModel(title: $title, author: $author, content: $content, urlToImage: $urlToImage, description: $description, url: $url, publishedAt: $publishedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, title, author, content,
      urlToImage, description, url, publishedAt);
